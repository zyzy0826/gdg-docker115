...
def main():
    ...
    print("[最後一步] 把官網救回來")
    print()
    print("  六個 flag 你都有了。打開瀏覽器：http://localhost:8080")
    print("  六個都交齊的話，官網會自己活過來（網頁每 3 秒重讀一次 config.json）。")
    print("  還缺哪一個，打 mission 就知道。")
    print()
    print("  想看 flag 是怎麼被填進設定檔的：")
    print("    nano ~/club_server/website/config.json")
    print("  只改雙引號中間的部分，逗號和括號不要動。")
    print("  （我大二那年因為少一個逗號 debug 了兩小時。）")
    print()
    print("----------------------------------------------------------------")
    print()
    print("  謝謝你把它修好。")
    print()
    print("  社辦的燈記得關，冷氣……冷氣本來就是壞的。")
    print()
    print("                                        -- 小拿斯，最後一張便條")
    print()
